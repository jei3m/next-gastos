      ...
      >
        <div className="flex items-center gap-2">
          <ScrollWheel
            ...
            label="Hour"
          />
          <div className="text-sm font-semibold text-muted-foreground self-start mt-4">
            :
          </div>
          <ScrollWheel
            value={minute}
...
function ScrollWheelPeriod({
  ...
  useEffect(() => {
    if (
      ...
      const targetScroll =
        (periods.indexOf(value) || 0) * itemHeight;
      scrollContainerRef.current.scrollTop = targetScroll;
    }
  }, [value, periods]);
