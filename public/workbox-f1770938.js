define(['exports'], function (t) {
    ...
    constructor(t, e, s) {
      super(
        ({ url: e }) => {
          ...
          if (
            s &&
            (e.origin === location.origin || 0 === s.index)
          )
            return s.slice(1);
        },
        e,
  ...
  class v {
    ...
    async fetch(t) {
      ...
      const r = this.hasCallback('fetchDidFail')
        ? n.clone()
        : null;
      try {
    ...
    async q(t, e, n) {
      ...
      try {
        ...
        if (s instanceof Error)
          for (const i of t.iterateCallbacks(
            'handlerDidError'
          ))
            if (
              ((r = await i({
  ...
  class F {
    ...
    async expireEntries() {
      ...
      ((this.O = !1),
        this.T && ((this.T = !1), b(this.expireEntries())));
    }
  ...
  class V {
    constructor({ precacheController: t }) {
      ((this.cacheKeyWillBeUsed = async ({
        ...
        return s
          ? new Request(s, { headers: t.headers })
          : t;
      }),
        (this.W = t));
    }
    ...
    A() {
      ...
      for (const [s, n] of this.plugins.entries())
        n !== Y.copyRedirectedCacheableResponsesPlugin &&
          (n === Y.defaultPrecacheCacheabilityPlugin &&
            (t = s),
          n.cacheWillUpdate && e++);
      0 === e
        ? this.plugins.push(
      ...
      for (const n of t) {
        ...
        if (this.F.has(r) && this.F.get(r) !== t)
          throw new s(
            ...
            { firstEntry: this.F.get(r), secondEntry: t }
          );
        if ('string' != typeof n && n.integrity) {
          if (
            this.$.has(t) &&
            this.$.get(t) !== n.integrity
          )
            throw new s(
        ...
        if (
          (this.F.set(r, t), this.H.set(r, i), e.length > 0)
        ) {
    ...
    constructor(t, e) {
      super(({ request: s }) => {
        ...
        for (const r of (function* (
          ...
          if (
            (yield a.href, s && a.pathname.endsWith('/'))
          ) {
  ...
  ((t.CacheFirst = class extends R {
    ...
    (t.ExpirationPlugin = class {
      ...
      J(t) {
        ...
        let e = this.Y.get(t);
        return (
          e || ((e = new F(t, this.X)), this.Y.set(t, e)),
          e
        );
      }
      V(t) {
    ...
    (t.NetworkFirst = class extends R {
      ...
      async U(t, e) {
        ...
        const o = await e.waitUntil(
          (async () =>
            (await e.waitUntil(Promise.race(r))) ||
            (await a))()
        );
